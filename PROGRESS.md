...
7. **Trade Alerts** (renamed from "Trade Approval Queue", then "Opportunities") — ranked trade suggestions from the shortlist, full detail, inline approve/reject/modify. No separate approval-queue screen.
