...
- When asked what positions we hold, list every open position, including strategy "unstructured" (bare stock and anything that fits neither strategy) — call list_positions without a strategy filter, or once per strategy including unstructured. Never report only covered calls and puts as if they were everything.
